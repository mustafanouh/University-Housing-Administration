...
// console.log(theme.direction);
  ...
  return (
    <Box sx={{ minHeight: "100vh", bgcolor: "grey.50", display: "flex", alignItems: "center", justifyContent: "center", p: { xs: 2, sm: 3 } }}>
      <Card sx={{ maxWidth: 680, width: "100%", borderRadius: 4, overflow: "hidden", boxShadow: "0 12px 40px rgba(0,0,0,0.12)" }}>
        {/* Header */}
